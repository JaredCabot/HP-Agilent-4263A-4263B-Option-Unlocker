...
print("---------------------------------------------------")
print("|    HP / Agilent 4263A/B Option Unlocker Scrip   |")
print("|        Near Far Media - v1.1.1 20250330         |")
print("---------------------------------------------------\n")
print("This script will automatically enable options 001")
print("and 002 on your HP / Agilent 4263A or 4263B LCR Meter.\n")
...
print("Ensure the 4263A/B is powered on, connected to the PC")
print("and visible in the respective software package.\n")
print("NOTE: If the 20kHz output doesn't work, your instrument")
print("probably needs that range calibrated. This requires")
print("unobtanium software to perform the adjustment/calibration.")
...
target_device_id = '4263'  # Instrument to search for
...
inst_model = inst_id.split(",")[1]
print(f"Device {inst_model} found")
...
if inst_model == "4263A" and float(inst_firmware) < 2.00:
    print("*** This is an outdated firmware, upgrade to 2.00 is recommended ***\n")
    
if inst_model == "4263B" and float(inst_firmware) < 1.60:
